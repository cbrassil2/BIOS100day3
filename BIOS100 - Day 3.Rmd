...
1) Add a figure to "Your Project.RMD", which you started in the BIOS100day2 Workspace in Posit. Upload the report with the figure to the Assignment "Your Project - Figure".

2) Complete "Your Project - Debug", which is a reflection question on any struggles you are having in creating the figure. 